 ...
 */
export const SUPPORTED_APP_LOCALES = ["en", "de", "fr", "es", "ja", "pt"];

let _userLocale: string | null = null,
    _polarisTranslations: TranslationDictionary | null = null;
...
export function getPolarisTranslations() {
    return _polarisTranslations as TranslationDictionary;
}
 ...
 * add try catch LanguageDetector in case some browser block get local storage, cookie from iframe
