...
import "@swift/styles/global.scss";
import "@swift/styles/swift.scss";
import { LinkLikeComponentProps } from "@shopify/polaris/build/ts/src/utilities/link/types";
import { getPolarisTranslations } from "@swift/utils/i18nUtils";
 ...
 *
 */
const PolarisProvider: React.FC<{
	children: React.ReactNode;
}> = ({ children }) => {
	const translations = getPolarisTranslations();
	return (
		<main data-color-scheme="swift">
			<AppProvider linkComponent={AppBridgeLink} i18n={translations}>
				{children}
			</AppProvider>
		</main>
	);
