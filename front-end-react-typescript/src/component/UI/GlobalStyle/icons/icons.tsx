...
export enum EIcons {
    ...
    Icons8 = "Icons8",
    Icons9 = "Icons9",
    IconsOther1 = "IconsOther1",
    IconsOther2 = "IconsOther2",
    IconsOther3 = "IconsOther3",
...
export const Icons3 = ({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width={width} height={height}>
...
export const Icons6 = ({
    ...
    <svg width={width} height={height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
        ...
        <path fill="#DD2E44" d="M1 8l2 2 2-2 2 2 2-2 2 2 2-2 2 2 2-2 2 2 2-2v23H1z"></path><path fill="#FFCC4D" d="M25 5c-4.418 0-8 3.582-8 8v8h2v-8c0-3.314 2.688-6 6-6 3.315 0 6 2.686 6 6v8h2v-8c0-4.418-3.582-8-8-8z">
        </path><path fill="#744EAA" d="M15 13l2 2 2-2 2 2 2-2 2 2 2-2 2 2 2-2 2 2 2-2v23H15z"></path></svg>
)
export const Icons7 = ({
    width = "2.4rem", height = "2.4rem"
}: IconsType) => (
...
export const Icons8 = ({
    ...
    <svg width={width} height={height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
        ...
        <path fill="#FFCC4D" d="M14.347 27.894l-2.314-.856-.9-3.3c-.118-.436-.513-.738-.964-.738-.451 0-.846.302-.965.737l-.9 3.3-2.313.856c-.393.145-.653.52-.653.938 0 .418.26.793.653.938l2.301.853.907 3.622c.112.444.511.756.97.756.459 0 .858-.312.97-.757l.907-3.622 2.301-.853c.393-.144.653-.519.653-.937 0-.418-.26-.793-.653-.937zM10.009 6.231l-2.364-.875-.876-2.365c-.145-.393-.519-.653-.938-.653-.418 0-.792.26-.938.653l-.875 2.365-2.365.875c-.393.146-.653.52-.653.938 0 .418.26.793.653.938l2.365.875.875 2.365c.146.393.52.653.938.653.418 0 .792-.26.938-.653l.875-2.365 2.365-.875c.393-.146.653-.52.653-.938 0-.418-.26-.792-.653-.938z"></path></svg>
)
export const Icons9 = ({
    width = "2.4rem", height = "2.4rem"
}: IconsType) => (
    <svg widths={width} height={height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44">
        <g className="nc-icon-wrapper">
...
export const IconTwitter = ({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" fill="none" role="img" aria-hidden="true" className="crayons-icon crayons-icon--default">
...
export const IconFacebook = ({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" role="img" aria-labelledby="at1ah7yqernyb8cwwtavhf0372oh8zy" className="IconsFacebook"><title id="at1ah7yqernyb8cwwtavhf0372oh8zy">Facebook</title>
...
export const IconGithub = ({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" role="img" aria-labelledby="aq0qcdp3zczl57cfo5qfivp2u6yrd2zt" className="IconsGithub"><title id="aq0qcdp3zczl57cfo5qfivp2u6yrd2zt">Github</title>
...
export const IconInsTagram = ({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" role="img" aria-labelledby="aaaaz94zbb2vw66mehn8e3y7xa8s4e6w" className=" IconInsTagram"><title id="aaaaz94zbb2vw66mehn8e3y7xa8s4e6w">Instagram</title>
...
export const IconTwitch = ({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" role="img" aria-labelledby="a5mtrmidsng01uulsm7b5jd8bjn9p653" className="IconsTwitch"><title id="a5mtrmidsng01uulsm7b5jd8bjn9p653">Twitch</title>
...
export const IconMastodon = ({
    width, height
}: IconsType) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" role="img" aria-labelledby="arrgfrcx2xaxtnid2cb5enlzmyu7lipb" className="IconsMastodon"><title id="arrgfrcx2xaxtnid2cb5enlzmyu7lipb">Mastodon</title>
...
export const IconComment = ({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} role="img" aria-labelledby="ajgxbs72pw64b03ow03w09ymd1rxfdam" className="crayons-icon"><title id="ajgxbs72pw64b03ow03w09ymd1rxfdam">Comments</title><path d="M10.5 5h3a6 6 0 110 12v2.625c-3.75-1.5-9-3.75-9-8.625a6 6 0 016-6zM12 15.5h1.5a4.501 4.501 0 001.722-8.657A4.5 4.5 0 0013.5 6.5h-3A4.5 4.5 0 006 11c0 2.707 1.846 4.475 6 6.36V15.5z"></path></svg>
)
export const IconFuture = ({
    width = "2rem", height = "2rem"
}: IconsType) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} aria-hidden="true"><path d="M6.75 4.5h10.5a.75.75 0 01.75.75v14.357a.375.375 0 01-.575.318L12 16.523l-5.426 3.401A.375.375 0 016 19.607V5.25a.75.75 0 01.75-.75zM16.5 6h-9v11.574l4.5-2.82 4.5 2.82V6z"></path></svg>
)
...
export const IconEmail = ({
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" role="img" aria-hidden="true" className="crayons-icon crayons-icon--default">
